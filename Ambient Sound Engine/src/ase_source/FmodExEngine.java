...
public class FmodExEngine {
	...
	Soundcard stage; // object for sound card - stage out
	Soundcard preview; // object for sound card - preview out
...
class Soundcard {
	 ...
	 * This class is a subclass of Soundcard
	 */
	class Console {
